...
function stepMeta(isAr: boolean) {
  return [
    { icon: 'languages', eyebrow: isAr ? 'الخطوة 1 من 4' : 'Step 1 of 4', railLabel: isAr ? 'اللغة' : 'Language', title: isAr ? 'اختر لغتك' : 'Choose your language', lead: isAr ? 'يدعم بَلسَم العربية والإنجليزية بالكامل مع تخطيط من اليمين لليسار.' : 'Balsm supports full English and Arabic, with right-to-left layout for Arabic.' },
