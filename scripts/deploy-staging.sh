...
for var in RESEND_API_KEY RESEND_FROM OTP_LINK_BASE_URL OTP_APP_LINK_SCHEME OTP_WEB_APP_URL \
          GOOGLE_CLIENT_ID APPLE_CLIENT_ID \
          SENTRY_DSN SENTRY_TRACES_SAMPLE_RATE SENTRY_PROFILES_SAMPLE_RATE; do
  val="${!var:-}"
  [[ -z "$val" ]] && continue
