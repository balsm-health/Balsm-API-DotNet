...
namespace Balsam.Supervisor.Security;

public static class CertificateService
{
    private const string CertFileName = "supervisor.pfx";
    private const string CertPassword = "balsam-self-signed";
    ...
    public static X509Certificate2? EnsureCertificate(ILogger logger)
    {
        ...
        var request = new CertificateRequest(
            "CN=Balsam Healthcare Platform, O=Balsam",
            rsa,
        ...
        sanBuilder.AddDnsName("balsam.local");
