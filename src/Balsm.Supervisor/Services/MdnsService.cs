...
public sealed class MdnsService : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        try
        {
            ...
            // Respond to DNS queries for "balsm.local" with this machine's LAN IPs.
            // ServiceDiscovery.Advertise() only registers a DNS-SD service record (_http._tcp)
            // — it does NOT create the A record that makes "balsm.local" actually resolve.
            ...
            serviceProfile.AddProperty("product", "Balsm Healthcare Platform");
